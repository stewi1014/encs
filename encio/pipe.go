...
// io.ErrClosedPipe will be returned by subsequent calls to Write,
// and calls to Read after the buffer is emptied.
...
// CloseWith closes the pipe with a specific error.
// err will be returned by subsequent calls to Write,
// and calls to Read after the buffer is emptied.
