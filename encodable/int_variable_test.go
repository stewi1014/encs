...
func BenchmarkVarintEncode(b *testing.B) {
	b.Run("int64", func(b *testing.B) {
		...
		enc := encodable.NewVarint(reflect.TypeOf(send))
...
func BenchmarkVarintDecode(b *testing.B) {
	...
	int64Enc := encodable.NewVarint(reflect.TypeOf(int64(0)))
	uint16Enc := encodable.NewVarint(reflect.TypeOf(uint16(0)))
	float64Enc := encodable.NewVarint(reflect.TypeOf(float64(0)))
