...
func TestFloat32(t *testing.T) {
	...
	enc := encode.NewFloat32(reflect.TypeOf(float32(0)))
...
func TestFloat64(t *testing.T) {
	...
	enc := encode.NewFloat64(reflect.TypeOf(float64(0)))
...
func TestComplex64(t *testing.T) {
	...
	enc := encode.NewComplex64(reflect.TypeOf(complex64(0)))
...
func TestComplex128(t *testing.T) {
	...
	enc := encode.NewComplex128(reflect.TypeOf(complex128(0)))
...
func TestVarComplex(t *testing.T) {
	...
	for _, tC := range testCases {
		t.Run(tC.desc, func(t *testing.T) {
			...
			enc := encode.NewVarComplex(encodedValue.Type())
			dec := encode.NewVarComplex(decodeValue.Type())
