...
func TestInt8(t *testing.T) {
	enc := encode.NewInt8(reflect.TypeOf(int8(0)))
	for tC := int8(-1 << 7); ; tC++ {
...
func TestInt16(t *testing.T) {
	enc := encode.NewInt16(reflect.TypeOf(int16(0)))
...
func TestInt32(t *testing.T) {
	...
	enc := encode.NewInt32(reflect.TypeOf(int32(0)))
...
func TestInt64(t *testing.T) {
	...
	enc := encode.NewInt64(reflect.TypeOf(int64(0)))
...
func TestInt(t *testing.T) {
	...
	enc := encode.NewInt(reflect.TypeOf(int(0)))
